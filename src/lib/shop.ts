...
export const SHOP_ITEMS: ShopItem[] = [
  ...
  { id: 'skin_terminal', name: 'Card Skin: Terminal', description: 'Clean cards with fresh green command-line edges.', cost: 650, type: 'card-skin', consumable: false },
  { id: 'skin_hologram', name: 'Card Skin: Hologram', description: 'Iridescent light card surfaces with bright edges.', cost: 800, type: 'card-skin', consumable: false },
  { id: 'skin_paper', name: 'Card Skin: Paper', description: 'Warm paper-light panels with ink-like contrast.', cost: 650, type: 'card-skin', consumable: false },
  { id: 'skin_obsidian', name: 'Card Skin: Obsidian', description: 'Sharp white cards with bold violet edges.', cost: 850, type: 'card-skin', consumable: false },
